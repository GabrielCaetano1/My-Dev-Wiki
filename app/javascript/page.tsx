...
async function fetchData() {
  ...
  return response.json();
              ...
              <section className="flex flex-col">
                <h2 className="text-base font-semibold text-muted-foreground  px-7">• Controle de Fluxo:</h2>
                <CodeBlock
                  language="javascript"
                  code={`// Condicional
if (idade >= 18) {
              ...
              <section>
                <div className="text-base font-semibold text-muted-foreground px-7">
                  ...
                  <p className="font-normal">
                    Em JavaScript, existem três formas de declarar variáveis: <code>var</code>, <code>let</code> e <code>const</code>.
                    A diferença entre elas está no escopo e na mutabilidade. <code>var</code> tem escopo de função e pode ser redeclarada, enquanto <code>let</code> tem escopo de bloco e não pode ser redeclarada. 
                    Já <code>const</code> é usada para declarar constantes, ou seja, valores que não podem ser reatribuídos após a inicialização.
                  </p>
                </div>
                <CodeBlock 
                  language="javascript"
...
const z = 30; // Constante (não pode ser reatribuída)`}
              ...
              <section>
                <div className="text-base font-semibold text-muted-foreground px-7">
                  ...
                  <p className="font-normal">
                    Em JavaScript, os tipos de dados incluem: <code>string</code>, <code>number</code>, <code>boolean</code>, <code>array</code> e <code>object</code>.
              ...
              <section>
                <div className="text-base font-semibold text-muted-foreground px-7">
                  ...
                  <p className="font-normal">
                    ...
                    A diferença entre elas está na sintaxe e no comportamento do <code>this</code>.
                  </p>
                </div>
                <CodeBlock 
                  language="javascript"
  ...
  return dados;
              ...
              <section>
                <div className="text-base font-semibold text-muted-foreground px-7">
                  <h2>• This:</h2>
                  <p className="font-normal">
                    O operador <code>this</code> refere-se ao objeto que está chamando o método. Seu valor pode variar dependendo do contexto em que é usado. 
                    Em funções tradicionais, <code>this</code> se refere ao objeto que chamou a função, enquanto em arrow functions, <code>this</code> é léxico e se refere ao contexto onde a função foi definida.
                  </p>
                </div>
                  <CodeBlock 
                  language="javascript"
              ...
              <section>
                <div className="text-base font-semibold text-muted-foreground px-7">
                  ...
                  <p className="font-normal">
                    ...
                    Os principais tipos são <code>for</code>, <code>while</code> e <code>do...while</code>.
                  </p>
                </div>
                <CodeBlock 
                  language="javascript"
